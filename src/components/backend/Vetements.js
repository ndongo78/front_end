...
const Vetements=()=> {
    ...
    const {vetement,addCart}=useContext(dataContext1)
    const [products,setproducts]=useState(false)
    const [chaussures,setchaussures]=useState(false)
    const [vetements,setvetements]=useState(true)
 ...
 const handleNewProduct=(e)=>{
    ...
    return (
        ...
        <div className='container-fluid ' >
         <ScrollToTop smooth />
        <h1 className='text-center font-weight-bolder mt-2 btn-dark rounded-lg mb-5'>Nos Vétements</h1>
        <div className="row">
